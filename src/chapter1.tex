...
and low latency between a large number of computing nodes. Today,
interconnects of state-of-the-art HPC systems connect tens of thousands of
computing nodes where the bandwidth between two computing nodes reaches over
...
achieve higher communication performance between computing nodes. Third, the
