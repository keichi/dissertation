...
Section~\ref{ii-related-work} reviews related work. Section~\ref{ii-proposal}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{traffic_matrix}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{simulator_flowchart}
