...
Passing Interface (MPI)~\cite{Gropp1999,MessagePassingInterfaceForum2012} has
...
presented. In Section~\ref{evaluation}, an evaluation on a cluster system is
conducted to verify the feasibility of the proposed mechanism.
Section~\ref{related-work} discusses related works. In
...
\hypertarget{related-works-on-optimization-and-performance-tuning-of-mpi-collective-operations}{%
...
MPI\_Alltoall~\cite{Bruck1997}, MPI\_Reduce\_scatter~\cite{Iannello1997},
MPI\_Reduce and MPI\_Allreduce~\cite{Rabenseifner1997}. Most of the optimized
...
\emph{K-computer}~\cite{Yokokawa2011} has a hardware module called \emph{Tofu
Barrier Interface}~\cite{Ajima2012} on all nodes. This module executes
...
MPI\_Bcast~\cite{Dashdavaa2013}. The simplest implementation of MPI\_Bcast has
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=6.5cm]{problem-routing1.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=6.5cm]{problem-routing2.png}
...
InfiniBand~\cite{infiniband} is a computer network communication link
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=6.0cm]{sdn-architecture.png}
    \caption{Software Defined Networking Architecture.}%
    \label{fig-sdn-architecture}
\end{figure}

\hypertarget{proposed-mpi_allreduce-using-sdn}{%
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=8.0cm]{proposal-placement.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=7.0cm]{proposal-sequence.png}
...
paper focuses on \emph{recursive doubling}~\cite{Thakur2005}, since it
...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[width=8.0cm]{recursive-doubling.png}
    \end{center}
...
framework Trema~\cite{trema} 0.4.6 and Ruby~\cite{ruby} 1.9.3. The SDN
...
OpenMPI~\cite{Gabriel2004} 1.5.4 was used.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=9.0cm]{experiment-environment.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=7.0cm]{evaluation-8nodes.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=7.0cm]{evaluation-8nodes-normalized.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=7.0cm]{evaluation-16nodes.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=7.0cm]{evaluation-16nodes-normalized.png}
...
MVAPICH~\cite{mvapich} can be raised. MVAPICH is an MPI implementation
targeting InfiniBand, which most of high-performance computing systems ranked
in TOP500 has adopted. In literature~\cite{PjesivacGrbovic2011}, Sur \emph{et
...
more powerful computing systems. Literature~\cite{Jiuxing2004} also
