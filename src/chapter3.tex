...
Section~\ref{iii-conclusion} concludes this paper and discusses issues
...
\begin{figure}
    \centering
    \includegraphics[width=.6\linewidth]{evaluation-8nodes.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.6\linewidth]{evaluation-8nodes-normalized.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.6\linewidth]{evaluation-16nodes-normalized.png}
