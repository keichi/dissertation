...
methods and analyze their problems. Subsequently, the goal of this chapter is
...
speedup of the proposed mechanism in comparison with the Open MPI
...
proposed MPI\_Allreduce. It shows how the proposed mechanism reduces the
