...
\dots, x_i^l$. After MPI\_Allreduce is completed, all processes have $y^0,
y^1, \dots, y^l$ where $y^j = x_0^j \oplus x_1^j \oplus \dots \oplus
...
example where 4 processes each having 5 values call MPI\_Allreduce with the
sum operator.
