...
sending different data to node 4 at the same moment
in~\ref{fig:problem-routing1}. If those two communications are routed within
...
\item Generating routes for MPI collectives to mitigate link contention and
    installing generated routes to SDN-enabled switches
